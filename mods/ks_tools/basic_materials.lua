...
minetest.register_craftitem("ks_tools:deadshrub_stick", {
	description = "Packed Dead Shrub",
	inventory_image = "tools.deadshrub_stick.png",
	wield_image = "tools.deadshrub_stick.png",
	groups = {wood_stick = 1, deadshrub_stick = 1}
})
